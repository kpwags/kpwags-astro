...
<div class="code-block-filename">Program.cs</div>
```csharp Program.cs
...
<div class="code-block-filename">UserAccountDto.cs</div>
...
<div class="code-block-filename">App.razor</div>
```razor App.razor
...
<div class="code-block-filename">NavBar.razor</div>
```razor NavBar.razor
...
<div class="code-block-filename">AccountService.cs</div>
...
<div class="code-block-filename">Login.razor</div>
```csharp Login.razor
@code {
	...
    try

...
![A screenshot of my movies page showing a list of the most recent movies I've watched](../../assets/images/posts/2023-09-08-integrating-notion-into-my-site/movie_page_screenshot.jpg)
...
<div class="code-block-filename">NotionShared.ts</div>
...
<div class="code-block-filename">NotionMovie.ts</div>
...
<div class="code-block-filename">Notion.ts</div>
...
<div class="code-block-filename">Movie.ts</div>
```typescript Movie.ts
interface Movie {
    id: string;
    title: string;
